...
function renderYouTube(video) {
  return `    <div class="video-frame"><iframe src="https://www.youtube.com/embed/${video.youtubeId}?rel=0&amp;controls=1&amp;autoplay=0&amp;mute=0&amp;start=0" frameborder="0" style="position:absolute;left:0;top:0;width:100%;height:100%;pointer-events:auto" allow="autoplay; encrypted-media" allowfullscreen="" title="${video.title}"></iframe></div>
...
` : "";
  const primaryBlocks = (primary.blocks || []).map((block) => {
    ...
    return `          <div class="project-section">
            ...
            <div class="project-richtext">${remapSweClassicHtml(block.bodyHtml)}</div>
...
${renderYouTube(project.content.hero.video).replace(/^/gm, "            ")}
        ...
        <div class="box" id="overview">
          <div class="box-title">${overview.title}</div>
          <div class="box-body">
            <div class="project-richtext">${remapSweClassicHtml(overview.bodyHtml)}</div>
          </div>
        </div>
${extraVideo}        <div class="box" id="details">
          <div class="box-title">${primary.title}</div>
          <div class="box-body">
${primaryBlocks}
          </div>
        </div>`;
