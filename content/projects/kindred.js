...
module.exports = {
  ...
  content: {
    ...
    sections: [
      {
        bodyHtml: "<p>Kindred helps people preserve meaningful experiences with the context needed to revisit them later. Each Moment combines personal writing with people, activities, time, place, feelings, photos, and optional intimacy and Apple Health details.</p><div class=\"project-app-store-cta\"><a href=\"https://apps.apple.com/app/kindred-private-journal/id6792446484\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"project-app-store-button\" aria-label=\"Download Kindred on the App Store\"><svg viewBox=\"0 0 384 512\" aria-hidden=\"true\" class=\"project-app-store-icon\"><path d=\"M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-77.7-19.7C63.3 141.2 4 183.5 4 269.5c0 25.5 4.6 51.6 13.9 78.3 12.4 35.5 57.1 122.5 103.8 121.1 24.4-.6 41.7-17.3 73.5-17.3 30.8 0 46.9 17.3 74.1 17.3 47.1-.7 87.7-79.8 99.5-115.4-63.1-29.7-59.8-83-50.1-84.8zM260.5 104.5c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 68.6-34.3z\"></path></svg><span>Download on the App Store</span></a></div>"
      },
      {
        title: "The problem",
      ...
      },
      {
        title: "How it works",
        bodyHtml: [
          "<p>A Moment connects personal writing with people and context, then makes each record easy to capture, revisit, organize, and understand.</p>",
          ...
          "<article class=\"dear-interaction-item\"><img src=\"/images/kindred-insights.png\" loading=\"lazy\" alt=\"Kindred Insights view\" class=\"kindred-feature-image\"><h3 class=\"dear-interaction-title\">Insights</h3><p class=\"dear-interaction-description\">Explore descriptive patterns without scores or judgment.</p></article>",
      ...
      },
      {
        ...
        bodyHtml: [
          "<p>Kindred handles sensitive material, so trust must be visible in the interface and supported by the data model. Clear structure, visible control, restrained language, and familiar system behavior keep the experience calm and understandable.</p>",
          ...
          "<section class=\"dear-interaction-item\"><div class=\"kindred-design-visual kindred-disclosure-visual\" aria-hidden=\"true\"><div class=\"kindred-settings-header\"><span class=\"kindred-glass-control kindred-glass-icon\"><i class=\"kindred-app-icon kindred-icon-caret-left\"></i></span><strong>Privacy</strong></div><span class=\"kindred-settings-label\">Face ID</span><div class=\"kindred-settings-row\"><span>App Lock with Face ID</span><i class=\"kindred-native-switch is-off\"></i></div><div class=\"kindred-settings-row is-secondary\"><span>Lock after</span><span>1 minute</span></div></div><h3 class=\"dear-interaction-title\">Trust through control</h3><p class=\"dear-interaction-description\">Familiar system controls and plain language make protection choices visible, understandable, and easy to change.</p></section>",
          ...
          "<section class=\"dear-interaction-item\"><div class=\"kindred-design-visual kindred-native-visual\" aria-hidden=\"true\"><div class=\"kindred-native-content\"><span></span><span></span><span></span></div><div class=\"kindred-tab-controls\"><div class=\"kindred-glass-control kindred-tab-bar\"><i class=\"kindred-app-icon kindred-icon-journal is-active\"></i><i class=\"kindred-app-icon kindred-icon-calendar\"></i><i class=\"kindred-app-icon kindred-icon-people\"></i><i class=\"kindred-app-icon kindred-icon-person\"></i></div><span class=\"kindred-glass-control kindred-tab-add\"><i class=\"kindred-app-icon kindred-icon-add\"></i></span></div></div><h3 class=\"dear-interaction-title\">Native interaction</h3><p class=\"dear-interaction-description\">Native components keep navigation and controls familiar, support Dynamic Type, and adopt Liquid Glass on iOS 26.</p></section>",
          "</div><script src=\"/js/kindred-design-scale.js\" defer></script>"
        ].join("")
      },
      {
        title: "Privacy by design",
        bodyHtml: [
          "<p>These experience principles are supported by local-first storage, protected access, and practical data controls.</p>",
          "<div class=\"kindred-text-columns kindred-text-columns-three\"><section class=\"dear-interaction-item\"><img src=\"/images/kindred-private-storage.png\" loading=\"lazy\" alt=\"A locked journal stored inside a cloud\" class=\"kindred-column-illustration\"><h3 class=\"dear-interaction-title\">Private storage</h3><p class=\"dear-interaction-description\">SwiftData keeps records on the device and CloudKit can sync them through the user's private iCloud database. Kindred has no separate account, advertising, or third-party analytics SDK.</p></section><section class=\"dear-interaction-item\"><img src=\"/images/kindred-explicit-protection.png\" loading=\"lazy\" alt=\"A shield with a checkmark and privacy control\" class=\"kindred-column-illustration\"><h3 class=\"dear-interaction-title\">Protected access</h3><p class=\"dear-interaction-description\">Optional App Lock uses Face ID, Touch ID, or the device passcode, while a privacy shield covers sensitive content when the app leaves the foreground. Apple Health access and individual syncs remain optional.</p></section><section class=\"dear-interaction-item\"><img src=\"/images/kindred-data-ownership.png\" loading=\"lazy\" alt=\"A record box with export and restore arrows\" class=\"kindred-column-illustration\"><h3 class=\"dear-interaction-title\">Data ownership</h3><p class=\"dear-interaction-description\">ZIP backup and restore make records portable, while in-app deletion controls let people remove stored content.</p></section></div>"
        ].join("")
      },
      {
        title: "What's next",
        bodyHtml: "<p>I plan to explore optional partner collaboration while preserving the privacy and personal control central to Kindred. If you have feedback or ideas, I would be glad to hear from you at <a href=\"mailto:roberttqwei@gmail.com\" class=\"link-in-paragraph\">roberttqwei@gmail.com</a>.</p>"
      },
      {
        title: "Project links",
